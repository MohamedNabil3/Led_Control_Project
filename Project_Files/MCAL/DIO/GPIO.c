...
uint8 DIO_ReadPinValue (Port port, Pin pin){
	...
	{
		case DIO_PORTA:
		reading = GET_BIT(GPIO_PORTA_DATA_R, pin);
		break;
		case DIO_PORTB:
		reading = GET_BIT(GPIO_PORTB_DATA_R, pin);
		break;
		case DIO_PORTC:
		reading = GET_BIT(GPIO_PORTC_DATA_R, pin);
		break;
		case DIO_PORTD:
		reading = GET_BIT(GPIO_PORTD_DATA_R, pin);
		break;
		case DIO_PORTE:
		reading = GET_BIT(GPIO_PORTE_DATA_R, pin);
		break;
		case DIO_PORTF:
		reading = GET_BIT(GPIO_PORTF_DATA_R, pin);
		break;
	}
	return reading;
}
...
uint32 DIO_ReadPortValue(Port port){
	...
	{
		case DIO_PORTA:
		    reading = GPIO_PORTA_DATA_R;
		    break;
		case DIO_PORTB:
		    reading = GPIO_PORTB_DATA_R;
		    break;
		case DIO_PORTC:
		    reading = GPIO_PORTC_DATA_R;
		    break;
		case DIO_PORTD:
		    reading = GPIO_PORTD_DATA_R;
		    break;
		case DIO_PORTE:
		    reading = GPIO_PORTE_DATA_R;
		    break;
		case DIO_PORTF:
		    reading = GPIO_PORTF_DATA_R;
		    break;
	}
	return reading;
}
